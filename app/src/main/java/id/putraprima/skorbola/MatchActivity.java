...
public class MatchActivity extends AppCompatActivity {
    ...
    public void handleCekHasil(View view) {
        ...
        if (homeScoreVal > awayScoreVal){
            intent.putExtra("result", "The winner is " + homeTeam.getText().toString());
        }else if(homeScoreVal < awayScoreVal){
            intent.putExtra("result", "The winner is " + awayTeam.getText().toString());
        }else{
            intent.putExtra("result","The result is Draw");
        }
